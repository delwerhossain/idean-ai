                ...
                <div className="text-center mb-6">
                  ...
                  {billingPeriod === "annual" && plan.price > 0 && (
                    <div className="text-sm text-green-600 font-medium">
                      ৳
                      {Math.round(
                        calculateAnnualPrice(plan.price, 30) / 12
                      ).toLocaleString()}
                      /month (30% off annually)
                    </div>
                  )}
          ...
          <Card className="p-6 bg-gradient-to-r from-gray-50 to-blue-50">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Pick and choose specific modules you need
                </p>
              </div>
              <Button
                variant="outline"
            ...
            <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
              <p className="text-sm text-green-800">
                <strong>Bundle Discount:</strong> Get 20% off when you purchase
                2 or more modules!
              </p>
            </div>
          </Card>
